...
CLI subprocesses receive common Homebrew and system bin paths so CodexBar can
find provider CLIs even when Stream Deck does not inherit the login shell PATH.
